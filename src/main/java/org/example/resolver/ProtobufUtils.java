...
public class ProtobufUtils {
    ...
    static {
        ...
        PRIMITIVE_TYPE_MAPPING.put(String.class, string.class);
        PRIMITIVE_TYPE_MAPPING.put(Integer.class, int32.class);
        PRIMITIVE_TYPE_MAPPING.put(Long.class, int64.class);
    }
    ...
    static {
        ...
        PRIMITIVE_KEY_MAPPING.put(String.class, string.class);
        PRIMITIVE_KEY_MAPPING.put(Integer.class, int32.class);
        PRIMITIVE_KEY_MAPPING.put(Long.class, int64.class);
    }
